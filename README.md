# nvim-treesitter-queries-scheme

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-scheme/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-scheme/actions/workflows/validate.yml)

Neovim tree-sitter queries for **scheme**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-scheme",
...
- [ ] Changes are scoped to `scheme` — do not include files for other languages
